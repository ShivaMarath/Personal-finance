...
import { Account, Transaction, TransactionType } from "@/lib/generated/prisma";
...
// Serialized types for transactions and accounts
...
export function DashboardOverview({ accounts, transactions }: DashboardOverviewProps) {
  ...
  const pieChartData: PieChartDataItem[] = Object.entries(expensesByCategory).map(
    ([category, amount]) => ({
      name: category,
      value: amount,
    })
